        ...
        <div className="space-y-6 md:space-y-8">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
            <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-[#6851FF]/8 border border-[#6851FF]/20 mb-4 md:mb-6">
              ...
              <span className="text-xs md:text-sm font-medium text-[#6851FF]">{t.hero.badge}</span>
            </div>
          ...
          >
            <Button
              ...
              className="group bg-[#6851FF] hover:bg-[#5741e0] shadow-lg shadow-[#6851FF]/25"
            ...
            >
              {t.hero.ctaSecondary} <ExternalLink className="ml-2 w-4 h-4 opacity-50 group-hover:opacity-100" />
            </Button>
          </motion.div>
          ...
          >
            ...
            <div className="bg-[#6851FF] px-5 pt-8 pb-10 relative">
              <div className="flex justify-between items-center mb-1">
                <span className="text-white/70 text-xs font-sans">{t.hero.cardBalance}</span>
                <span className="text-white/70 text-xs bg-white/10 px-2 py-0.5 rounded-full">{t.hero.cardLive}</span>
              </div>
              <div className="text-3xl font-sans tabular-nums tracking-tight font-bold text-white">$1,240.00</div>
              <div className="flex items-center gap-1.5 mt-1.5">
                <TrendingUp className="w-3.5 h-3.5 text-emerald-300" />
                <span className="text-emerald-300 text-xs font-sans tabular-nums">{t.hero.cardYield}</span>
              </div>
            </div>
            ...
            <div className="px-5 pb-6 -mt-4 relative z-10 space-y-4">
              <div className="bg-white rounded-xl border border-slate-100 p-3 shadow-sm flex items-center gap-3">
                ...
                <div>
                  <div className="text-[10px] text-slate-400 font-sans">{t.hero.cardOwnership}</div>
                  <div className="text-sm font-semibold text-[#081229]">{t.hero.cardOwnershipLabel}</div>
                </div>
              </div>

              <div>
                <div className="text-[10px] text-slate-400 mb-2 font-sans uppercase tracking-widest">{t.hero.cardLastPayment}</div>
                <div className="flex items-center justify-between bg-slate-50 rounded-xl p-3 border border-slate-100">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <div className="text-xs font-semibold text-[#081229]">{t.hero.cardPixSent}</div>
                      <div className="text-[10px] text-slate-400">{t.hero.cardJustNow}</div>
                    </div>
                  </div>
              ...
              <button
                ...
                className="w-full bg-[#6851FF] text-white rounded-xl py-3 text-sm font-semibold shadow-md shadow-[#6851FF]/20 hover:bg-[#5741e0] transition-colors"
              >
                {t.hero.cardPayButton}
              </button>
            </div>
            ...
            >
              ...
              <span className="text-xs font-medium text-[#081229] whitespace-nowrap">{t.hero.cardEarning}</span>
            </motion.div>
            ...
            >
              ...
              <span className="text-xs font-medium text-[#081229] whitespace-nowrap">{t.hero.cardNetworks}</span>
            </motion.div>
          </motion.div>
        </div>
      </div>
